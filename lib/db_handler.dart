...
class DBHelper{
  ...
  Future<List<TodoModel>> searchTodoList(String query) async {
    var dbClient = await db;
    final List<Map<String, Object?>> searchResults = await dbClient!.rawQuery(
      "SELECT * FROM mytodo WHERE title LIKE '%$query%' OR desc LIKE '%$query%'"
    );
